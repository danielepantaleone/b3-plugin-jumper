...
class Test_commands(JumperTestCase):
    ...
    def setUp(self):
        ...
        when(self.console).getMaps().thenReturn(['ut4_abbey', 'ut4_abbeyctf', 'ut4_algiers', 'ut4_ambush',
            ...
            'ut4_kingdom', 'ut4_kingpin', 'ut4_mandolin', 'ut4_maya', 'ut4_oildepot', 'ut4_prague', 'ut4_prague_v2',
    ...
    def test_cmd_maprecord_with_arguments_no_record(self):
        ...
        # WHEN
        self.mike.clearMessageHistory()
        self.mike.says('!maprecord casa')
        # THEN
        self.assertListEqual(['no record found on ut4_casa'], self.mike.message_history)
    ...
    def test_cmd_maps(self):
        ...
        self.mike.says('!maps')
        # THEN
        self.assertListEqual(['map rotation: ut42_bstjumps_u2, ut42_jupiter'], self.mike.message_history)
    ...
    def test_cmd_map_invalid_name(self):
        ...
        # THEN
        self.assertListEqual(['do you mean: ut42_bstjumps_u2, ut42_jupiter?'], self.mike.message_history)